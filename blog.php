    ...
    <div class="container-fluid">
        ...
        <div class="profile-main">
            ...
            foreach ($posts as $post) {
                ...
                echo "<p>" . substr($post['post'], 0, 200) . "...</p>"; // Display a truncated version of the post content
                echo "<a href='fullpost.php?post_id={$post['post_id']}'>Read more</a>"; // Link to the full post
